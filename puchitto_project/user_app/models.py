...
class ContactUs(models.Model):
    full_name = models.CharField(max_length=200,verbose_name='お名前')
    email = models.CharField(max_length=200,verbose_name='メールアドレス')
    phone = models.CharField(max_length=200,verbose_name='電話番号') # +234 (456) - 789
    subject = models.CharField(max_length=200,verbose_name='タイトル') # +234 (456) - 789
